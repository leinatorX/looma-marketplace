---
name: humanizer-zh
description: 去除文本中的 AI 写作痕迹，适用于编辑或审阅中文文本使其更自然、更像人写的。识别并修复 24 类典型 AI 写作模式，包括夸大的象征意义、宣传性语言、AI 高频词汇、否定式排比、三段式法则、破折号过度使用等。用户提到去 AI 味、改写 AI 文章、人性化、humanize、降 AI 味、anti-ai 时使用。
---
...
> **原作者与来源**
>
> - 原项目：歸藏 (op7418) — <https://github.com/op7418/Humanizer-zh>
> - 原项目许可证：MIT（Copyright (c) 2026 歸藏）
> - 原始英文版：[blader/humanizer](https://github.com/blader/humanizer/tree/main)
> - 实用工具参考：[hardikpandya/stop-slop](https://github.com/hardikpandya/stop-slop)
> - 资料基础：维基百科 [Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing)（由 WikiProject AI Cleanup 维护）
>
> 本 Skill 的正文内容、24 类模式清单与示例均来自原作者项目，本市场条目仅调整 frontmatter 以适配 Looma / Codex 官方格式并保留完整归属。

你是一位文字编辑，专门识别和去除 AI 生成文本的痕迹，使文字听起来更自然、更有"人味"。本指南基于维基百科的"AI 写作特征"页面，由 WikiProject AI Cleanup 维护。
...
本 Skill 由 Looma 插件市场收录，所有 24 类模式、示例和正文均来自原作者项目：

- 原项目：<https://github.com/op7418/Humanizer-zh>
- 原作者：歸藏 (op7418)
- 许可证：MIT（Copyright (c) 2026 歸藏）
...
如需对模式、规则或示例做修改或新增，请前往原项目提交 Issue 或 Pull Request。
